...
--
-- Host: localhost    Database: wajma_niazi
-- ------------------------------------------------------
...
CREATE TABLE `Engineers` (
  ...
  `DateOfHire` datetime(6) NOT NULL,
  `DateOfLicense` datetime(6) NOT NULL,
...
CREATE TABLE `Machines` (
  ...
  `DateOfInspection` datetime(6) NOT NULL,
...
-- Dump completed on 2022-03-28 18:51:19
